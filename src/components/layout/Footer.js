        ...
        <footer>
            ...
            <div className="container">
                ...
                <div className="col-12 col-sm-6 col-lg-6 about">
                    ...
                    <p className="grey">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum dolorem voluptate
                    exercitationem vero, alias, necessitatibus culpa delectus repudiandae expedita in et nihil itaque maiores!
                    At!</p>
                    <p className="grey no-styles">We accept the following payment methods:</p>
                </div>
                <div className="col-12 col-sm-6 col-lg-3 connect">
                    ...
                    <form onSubmit={this.handleSubmit} >
                        <input type="email" />
                        <button className="button" onChange={this.handleChange} placeholder="Enter email..." value={this.state.email} >Join</button>
                    </form>
                </div>
                </div>
            </div>
